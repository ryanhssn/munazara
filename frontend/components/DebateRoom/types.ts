...
export type LogEntry =
  ...
  | { type: "turn"; role: "debater_a" | "debater_b"; round: number; roundName: string; vendor: string; model: string; title: string; content: string; tokens?: { input: number; output: number }; elapsedMs?: number; confidence?: number }
  ...
  | { type: "evidence"; agent: "debater_a" | "debater_b"; round: number; query: string; sources: EvidenceSource[] };
